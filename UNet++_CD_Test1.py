...
from keras.layers import Dense, Conv2D, MaxPooling2D, Dropout, Flatten, Concatenate,Conv2DTranspose, add,Concatenate,Add,Subtract
...
def standard_unit(input_tensor, stage, nb_filter, kernel_size=3, mode='None'):
    ...
    if mode == 'residual':
        # x=Add(name='resi'+stage)([x,input_tensor])
